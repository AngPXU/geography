...
export function DashboardOverview({ username, avatar, initialExp = 0, initialStreak = 0, initialStudySeconds = 0, initialPetExp = 0, initialCoins = 50 }: DashboardOverviewProps) {
    ...
    <section className="pt-8 pb-16 relative overflow-hidden bg-transparent">
      <div className="w-[90%] max-w-[1400px] mx-auto px-4 xl:px-8 relative z-10 space-y-6">
        ...
        {activeTab === 'overview' && <>
          ...
          {/* ── Pet & Badges Layout (3/4 - 1/4) ── */}
          <div className="mt-4 mb-6 flex flex-col xl:flex-row gap-6 items-stretch">
            <div className="w-full xl:w-3/4 flex flex-col">
              <PetGarden initialPetExp={initialPetExp} initialCoins={initialCoins} />
            </div>
